...
@EnableCaching
public class JCacheEhcacheSpringBootApplication {
	
	private final static Logger logger = LoggerFactory.getLogger(MethodHandles.lookup().getClass());	

	public static void main(String[] args) {
	 ConfigurableApplicationContext run = SpringApplication.run(JCacheEhcacheSpringBootApplication.class, args);
	 ...
	 logger.info("\n\n\n "+"=============================================================================================================================");	
		...
		for (String cacheName : cacheNames) {
		    ...
		    while(allCacheEntries.hasNext()){
		        ...
		        logger.info("Key:  {}  Value {} ",currentEntry.getKey().toString(), currentEntry.getValue());
		    }
		 }	
		logger.info("\n=====================================================[END]================================================================");	
		}	
