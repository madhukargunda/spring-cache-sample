...
@EnableCaching
public class SimpleCacheManagerSpringBootApplication {
	
	private final static Logger logger = LoggerFactory.getLogger(MethodHandles.lookup().getClass());	

	public static void main(String[] args) {
	 ConfigurableApplicationContext run = SpringApplication.run(SimpleCacheManagerSpringBootApplication.class, args);
