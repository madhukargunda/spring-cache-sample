...
import com.study.pattern.cache.key.JCacheKeyGeneraotrForAllParameters;
...
public class EmployeRepositoryImpl implements EmployeRepository {
	...
	@Autowired
	JCacheKeyGeneraotrForAllParameters cacheKeyGeneraotr;
	...
	@Override
	@CacheResult(cacheName="allEmployesCache",cacheKeyGenerator=JCacheKeyGeneraotrForAllParameters.class)
